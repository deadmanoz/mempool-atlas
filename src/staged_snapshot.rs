...
use crate::model::{
    ...
    ClassifierDescriptor, ClassifierSummary, KNOTS_BIP110_CLASSIFIER_ID,
    MAX_SUPPORTED_MEMPOOL_ENTRIES, MempoolEntry, MempoolSnapshot, SourceAvailability,
    SourceSummary,
};
...
fn validate_input(
    ...
    for transaction in &snapshot.transactions {
        ...
        if bip110_result.is_some() != transaction.bip110.is_some() {
            return Err(invalid(format!(
