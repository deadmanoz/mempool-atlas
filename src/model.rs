        ...
        ClassifierDescriptor {
            ...
            labels: vec![
                ...
                label(
                    "other_shape",
                    "Other shape",
                    "No registered transaction-shape heuristic matched.",
                ),
            ],
        },
        ClassifierDescriptor {
            ...
            labels: vec![
                ...
                label(
                    "stamps",
                    "Stamps",
                    "A bare-multisig data-in-keys fingerprint.",
                ),
                label(
                    "counterparty",
                    "Counterparty",
                    "A Counterparty payload prefix fingerprint.",
                ),
                label("omni", "Omni", "An Omni payload prefix fingerprint."),
                label(
                    "other_op_return",
                    "Other OP_RETURN",
