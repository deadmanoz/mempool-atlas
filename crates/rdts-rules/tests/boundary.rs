//! Boundary-case tests authored for this crate (beyond the official vectors).
//!
...
fn verdict(ev: &rdts_rules::TxEvidence, rule: RuleId) -> &RuleVerdict {
...
fn expired_context_is_inactive() {
    ...
    let expiry = ACTIVATION + rdts_rules::ACTIVE_DURATION;
    let ev = evaluate(
        &tx,
