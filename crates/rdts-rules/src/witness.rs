...
use crate::context::{ANNEX_TAG, TAPROOT_LEAF_MASK, TAPROOT_LEAF_TAPSCRIPT};
use bitcoin::Script;
...
impl TaprootScriptPath<'_> {
    ...
    /// Whether the leaf is a defined Tapscript (leaf version 0xc0).
    pub fn is_tapscript(&self) -> bool {
        self.leaf_version() == Some(TAPROOT_LEAF_TAPSCRIPT)
    }
}
