...
| ------------------- | ---------------: | ---------------: | ------ |
| Node primary        |  2,413,994 bytes |  3,189,229 bytes | pass   |
| Node complete       |  5,317,522 bytes |  6,059,535 bytes | pass   |
| Comparison primary  |  4,878,503 bytes |  5,740,612 bytes | pass   |
| Comparison complete | 10,615,949 bytes | 12,119,070 bytes | pass   |

At the pinned throughput, the corresponding projected wall clocks are 25.139,
47.347, 44.594, and 84.574 seconds. Each includes a two-second request
allowance and, respectively, an 8, 12, 12, or 16-second processing allowance.
The remaining margins against the release gates are 4.861, 4.653, 5.406, and
9.426 seconds. `just perf-web` verifies the end-to-end browser outcome rather
